package com.cebess.morsesender;

/**
 * Created by chasb on 11/23/2016.
 */
...
{
    private char                letter;                         /* Symbol to type       */
    private String              label;                          /* Button display       */
    private String              code;                           /* Dots and dashes      */
